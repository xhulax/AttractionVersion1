...
{
    public GameObject objectToSpawn, Left, Right, Up;
    int spawnTimer, spawning;
    int shapePick, spawnItem;
    ...
    void Start()
    {
        ...
        spawning = 20;
        spawnItem = 1;
        left = new Vector3(-26f, 9.5f);
        up = new Vector3(-23f, 9.5f);
        right = new Vector3(-20f, 9.5f);
    }
        ...
        if (game.state == "battle")
        {
            ...
            if (spawnTimer <= 0)
            {
                ...
                if (objectToSpawn == Left)
                {
                    ...
                    newLeft.transform.parent = GameObject.Find("EnemyArrowContainer").transform;
                    spawnItem++;
                }
                if (objectToSpawn == Up)
                {
                    ...
                    newUp.transform.parent = GameObject.Find("EnemyArrowContainer").transform;
                    spawnItem++;
                }
                if (objectToSpawn == Right)
                {
                    ...
                    newRight.transform.parent = GameObject.Find("EnemyArrowContainer").transform;
                    spawnItem++;
                }
                spawnTimer = spawning;
            }
